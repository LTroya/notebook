...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_NOTE_ID = "Note Identifier";
    public static final String EXTRA_NOTE_TITLE = "Note Title";
    public static final String EXTRA_NOTE_MESSAGE = "Note Message";
    public static final String EXTRA_NOTE_CATEGORY = "Note Category";
    public static final String EXTRA_NOTE_FRAGMENT_TO_LOAD = "Fragment To Load";
    public enum FragmentToLaunch{ CREATE, VIEW, EDIT };
